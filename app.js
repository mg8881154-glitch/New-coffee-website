const products=[{id:1,name:"Cappuccino",desc:"Rich espresso topped with velvety steamed milk foam.",price:3.50,img:"https://images.unsplash.com/photo-1509042239860-f550ce710b93",rating:4.5,cat:"hot"},{id:2,name:"Latte",desc:"Smooth espresso blended with creamy steamed milk.",price:4.00,img:"https://images.unsplash.com/photo-1495474472287-4d71bcdd2085",rating:4.7,cat:"hot"},{id:3,name:"Mocha",desc:"A rich blend of espresso, chocolate syrup and steamed milk.",price:4.50,img:"https://images.unsplash.com/photo-1511920170033-f8396924c348",rating:4.8,cat:"hot"},{id:4,name:"Espresso",desc:"Bold concentrated coffee shot.",price:2.50,img:"https://images.unsplash.com/photo-1510591509098-f4fdc6d0ff04",rating:4.3,cat:"hot"},{id:5,name:"Cold Brew",desc:"Slow-steeped for 12 hours for ultra-smooth cold coffee.",price:5.00,img:"https://images.unsplash.com/photo-1461023058943-07fcbe16d735",rating:4.6,cat:"cold"},{id:6,name:"Flat White",desc:"Velvety microfoam espresso with higher coffee-to-milk ratio.",price:4.00,img:"https://images.unsplash.com/photo-1572442388796-11668a67e53d",rating:4.4,cat:"hot"},{id:7,name:"Americano",desc:"Espresso diluted with hot water for smooth bold coffee.",price:3.00,img:"https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd",rating:4.2,cat:"hot"},{id:8,name:"Macchiato",desc:"Espresso stained with a dash of foamed milk.",price:3.50,img:"https://images.unsplash.com/photo-1485808191679-5f86510bd9d4",rating:4.4,cat:"hot"},{id:9,name:"Irish Coffee",desc:"Hot coffee with Irish whiskey brown sugar and whipped cream.",price:6.50,img:"https://images.unsplash.com/photo-1544787219-7f47ccb76574",rating:4.6,cat:"hot"},{id:10,name:"Iced Latte",desc:"Chilled espresso poured over ice with cold milk.",price:4.50,img:"https://images.unsplash.com/photo-1517701604599-bb29b565090c",rating:4.7,cat:"cold"},{id:11,name:"Affogato",desc:"Vanilla ice cream drowned in a hot espresso shot.",price:5.50,img:"https://images.unsplash.com/photo-1568649929103-28ffbefaca1e",rating:4.9,cat:"hot"},{id:12,name:"Turkish Coffee",desc:"Finely ground coffee brewed in a cezve. Rich and strong.",price:3.50,img:"https://images.unsplash.com/photo-1578374173705-969cbe6f2d6b",rating:4.5,cat:"hot"},{id:13,name:"Cortado",desc:"Equal parts espresso and warm milk.",price:3.50,img:"https://images.unsplash.com/photo-1534778101976-62847782c213",rating:4.4,cat:"hot"},{id:14,name:"Ristretto",desc:"Shorter more concentrated espresso shot.",price:2.50,img:"https://images.unsplash.com/photo-1596952954288-16862d37405b",rating:4.3,cat:"hot"},{id:15,name:"Vienna Coffee",desc:"Strong black coffee topped with whipped cream.",price:4.50,img:"https://images.unsplash.com/photo-1606791405792-1004f1718d0c",rating:4.6,cat:"hot"},{id:16,name:"Dalgona Coffee",desc:"Whipped instant coffee foam over cold milk.",price:4.00,img:"https://images.unsplash.com/photo-1590080875515-8a3a8dc5735e",rating:4.7,cat:"cold"},{id:17,name:"Lungo",desc:"Long espresso shot brewed with more water.",price:3.00,img:"https://images.unsplash.com/photo-1497515114629-f71d768fd07c",rating:4.2,cat:"hot"},{id:18,name:"Nitro Cold Brew",desc:"Cold brew infused with nitrogen for creamy texture.",price:5.50,img:"https://images.unsplash.com/photo-1558618666-fcd25c85cd64",rating:4.8,cat:"cold"},{id:19,name:"Kopi Luwak",desc:"The worlds rarest coffee. Earthy and smooth.",price:35.00,img:"https://images.unsplash.com/photo-1447933601403-0c6688de566e",rating:4.9,cat:"premium"},{id:20,name:"Black Ivory Coffee",desc:"Thai elephant-processed coffee. Ultra-rare and complex.",price:45.00,img:"https://images.unsplash.com/photo-1504630083234-14187a9df0f5",rating:5.0,cat:"premium"},{id:21,name:"Jamaican Blue Mountain",desc:"Grown at 7500ft altitude. Mild bright and no bitterness.",price:28.00,img:"https://images.unsplash.com/photo-1498804103079-a6351b050096",rating:4.9,cat:"premium"},{id:22,name:"Hawaiian Kona",desc:"Sun-grown on volcanic slopes of Hawaii.",price:22.00,img:"https://images.unsplash.com/photo-1495474472287-4d71bcdd2085",rating:4.8,cat:"premium"},{id:23,name:"Panama Geisha",desc:"Floral jasmine-like aroma. The most awarded coffee.",price:30.00,img:"https://images.unsplash.com/photo-1511920170033-f8396924c348",rating:5.0,cat:"premium"},{id:24,name:"Caramel Macchiato",desc:"Vanilla syrup steamed milk espresso and caramel drizzle.",price:5.00,img:"https://images.unsplash.com/photo-1485808191679-5f86510bd9d4",rating:4.7,cat:"hot"},{id:25,name:"Hazelnut Latte",desc:"Espresso with hazelnut syrup and creamy steamed milk.",price:4.50,img:"https://images.unsplash.com/photo-1517701604599-bb29b565090c",rating:4.6,cat:"hot"},{id:26,name:"Pumpkin Spice Latte",desc:"Espresso with pumpkin cinnamon nutmeg and clove.",price:5.50,img:"https://images.unsplash.com/photo-1572442388796-11668a67e53d",rating:4.5,cat:"hot"},{id:27,name:"Coconut Latte",desc:"Espresso with coconut milk and a hint of vanilla.",price:5.00,img:"https://images.unsplash.com/photo-1461023058943-07fcbe16d735",rating:4.6,cat:"hot"},{id:28,name:"Matcha Latte",desc:"Premium Japanese matcha blended with steamed milk.",price:5.50,img:"https://images.unsplash.com/photo-1536256263959-770b48d82b0a",rating:4.7,cat:"hot"},{id:29,name:"Chai Latte",desc:"Spiced black tea with steamed milk.",price:4.00,img:"https://images.unsplash.com/photo-1571934811356-5cc061b6821f",rating:4.5,cat:"hot"},{id:30,name:"Honey Oat Latte",desc:"Espresso with oat milk and a drizzle of honey.",price:5.00,img:"https://images.unsplash.com/photo-1509042239860-f550ce710b93",rating:4.8,cat:"hot"},{id:31,name:"Iced Americano",desc:"Espresso shots over ice with cold water.",price:3.50,img:"https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd",rating:4.4,cat:"cold"},{id:32,name:"Iced Cappuccino",desc:"Chilled espresso with cold foam and ice.",price:4.00,img:"https://images.unsplash.com/photo-1572442388796-11668a67e53d",rating:4.5,cat:"cold"},{id:33,name:"Iced Mocha",desc:"Espresso chocolate syrup cold milk and ice.",price:5.00,img:"https://images.unsplash.com/photo-1511920170033-f8396924c348",rating:4.7,cat:"cold"},{id:34,name:"Iced Caramel Latte",desc:"Espresso caramel syrup milk and ice.",price:5.00,img:"https://images.unsplash.com/photo-1485808191679-5f86510bd9d4",rating:4.8,cat:"cold"},{id:35,name:"Frappuccino",desc:"Blended ice espresso and milk topped with whipped cream.",price:5.50,img:"https://images.unsplash.com/photo-1461023058943-07fcbe16d735",rating:4.9,cat:"cold"},{id:36,name:"Cold Foam Latte",desc:"Espresso with cold milk and thick cold foam.",price:4.50,img:"https://images.unsplash.com/photo-1517701604599-bb29b565090c",rating:4.6,cat:"cold"},{id:37,name:"Iced Matcha Latte",desc:"Premium matcha over ice with cold milk.",price:5.50,img:"https://images.unsplash.com/photo-1536256263959-770b48d82b0a",rating:4.7,cat:"cold"},{id:38,name:"Iced Hazelnut Latte",desc:"Espresso hazelnut syrup and cold milk over ice.",price:5.00,img:"https://images.unsplash.com/photo-1495474472287-4d71bcdd2085",rating:4.5,cat:"cold"},{id:39,name:"Indian Cold Coffee",desc:"Chilled milk blended with instant coffee and sugar.",price:2.50,img:"https://images.unsplash.com/photo-1461023058943-07fcbe16d735",rating:4.6,cat:"indian"},{id:40,name:"Filter Coffee Shake",desc:"South Indian filter coffee blended with cold milk.",price:3.00,img:"https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd",rating:4.7,cat:"indian"},{id:41,name:"Badam Cold Coffee",desc:"Cold coffee with almond paste and saffron.",price:3.50,img:"https://images.unsplash.com/photo-1517701604599-bb29b565090c",rating:4.8,cat:"indian"},{id:42,name:"Rose Cold Coffee",desc:"Cold coffee with rose syrup and chilled milk.",price:3.00,img:"https://images.unsplash.com/photo-1572442388796-11668a67e53d",rating:4.5,cat:"indian"},{id:43,name:"Kesar Cold Coffee",desc:"Saffron-infused cold coffee with chilled milk.",price:4.00,img:"https://images.unsplash.com/photo-1509042239860-f550ce710b93",rating:4.9,cat:"indian"},{id:44,name:"Irani Cold Coffee",desc:"Inspired by Irani cafes of Hyderabad. Creamy and satisfying.",price:3.50,img:"https://images.unsplash.com/photo-1495474472287-4d71bcdd2085",rating:4.7,cat:"indian"}];
...
function renderCart(){
  ...
  if(cs) cs.innerText="$"+sub.toFixed(2);
...
function applyCoupon(){
  ...
  if(COUPONS[code]){discount=COUPONS[code];msg.style.color="#6dbf6d";msg.innerText="✅ "+discount+"% discount applied!";renderCart();}
  else{discount=0;msg.style.color="#e05555";msg.innerText="❌ Invalid coupon code";}
}
...
function updateOrderSummary(){
  ...
  if(os) os.innerText="$"+sub.toFixed(2);
  if(ot) ot.innerText="$"+total.toFixed(2);
...
function logoutUser(){
  currentUser=null;localStorage.removeItem("acUser");updateAuthUI();closeAllModals();showToast("Logged out successfully.");
}
